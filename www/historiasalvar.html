            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-body-options close">
                        <a class="modal-option" onclick="inserirTagUm()">
                            <div class="user-options-yes">
                                <h1>Salvar</h1>
                            </div>
                        </a>
                        <a class="modal-option close">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-body-options close-02">
                        <a class="modal-option" onclick="inserirTagDois()">
                            <div class="user-options-yes">
                                <h1>Salvar</h1>
                            </div>
                        </a>
                        <a class="modal-option close-02">
                            <div class="user-options-no">
                                <h1>Cancelar</h1>
                            </div>
                        </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-body-options close-03">
                        <a class="modal-option" onclick="inserirTitulo()">
                            <div class="user-options-yes">
                                <h1>Salvar</h1>
                            </div>
                        </a>
                        <a class="modal-option close-03">
                            <div class="user-options-no">
                                <h1>Cancelar</h1>
                            </div>
                        </a>
